...
// Returns the private 'debug.security.voter.Main\UserBundle\Security\Voter\ViewDoSurveyVoter' shared service.
...
return $this->privates['debug.security.voter.Main\UserBundle\Security\Voter\ViewDoSurveyVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(($this->privates['Main\UserBundle\Security\Voter\ViewDoSurveyVoter'] ?? $this->load('getViewDoSurveyVoterService.php')), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
