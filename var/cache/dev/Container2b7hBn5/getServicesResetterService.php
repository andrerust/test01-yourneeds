...
return $this->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () {
    ...
    return 0 + (int) (isset($this->privates['form.type.entity'])) + (int) (isset($this->privates['swiftmailer.email_sender.listener'])) + (int) (isset($this->privates['http_exception_listener'])) + (int) (isset($this->services['security.token_storage']));
}), ['form.type.entity' => 'reset', 'swiftmailer.email_sender.listener' => 'reset', 'http_exception_listener' => 'reset', 'security.token_storage' => 'setToken']);
