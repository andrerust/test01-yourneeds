...
// Returns the private 'debug.security.voter.Main\UserBundle\Security\Voter\ViewSurveyResultVoter' shared service.
...
return $this->privates['debug.security.voter.Main\UserBundle\Security\Voter\ViewSurveyResultVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(($this->privates['Main\UserBundle\Security\Voter\ViewSurveyResultVoter'] ?? $this->load('getViewSurveyResultVoterService.php')), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
