...
$instance->addEventSubscriber(($this->privates['Main\UserBundle\Doctrine\HashPasswordListener'] ?? $this->load('getHashPasswordListenerService.php')));
$instance->addEventSubscriber(($this->privates['stof_doctrine_extensions.listener.sluggable'] ?? $this->load('getStofDoctrineExtensions_Listener_SluggableService.php')));
