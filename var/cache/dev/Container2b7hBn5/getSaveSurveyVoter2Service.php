...
// Returns the private 'debug.security.voter.Main\UserBundle\Security\Voter\SaveSurveyVoter' shared service.
...
return $this->privates['debug.security.voter.Main\UserBundle\Security\Voter\SaveSurveyVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(($this->privates['Main\UserBundle\Security\Voter\SaveSurveyVoter'] ?? $this->load('getSaveSurveyVoterService.php')), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
