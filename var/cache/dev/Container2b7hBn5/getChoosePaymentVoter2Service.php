...
// Returns the private 'debug.security.voter.Main\UserBundle\Security\Voter\ChoosePaymentVoter' shared service.
...
return $this->privates['debug.security.voter.Main\UserBundle\Security\Voter\ChoosePaymentVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(($this->privates['Main\UserBundle\Security\Voter\ChoosePaymentVoter'] ?? $this->load('getChoosePaymentVoterService.php')), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
