...
// Returns the private 'debug.security.voter.Main\UserBundle\Security\Voter\ViewProfileVoter' shared service.
...
return $this->privates['debug.security.voter.Main\UserBundle\Security\Voter\ViewProfileVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(($this->privates['Main\UserBundle\Security\Voter\ViewProfileVoter'] ?? $this->load('getViewProfileVoterService.php')), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
