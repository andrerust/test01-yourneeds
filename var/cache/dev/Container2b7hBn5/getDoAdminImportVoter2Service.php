...
// Returns the private 'debug.security.voter.Main\UserBundle\Security\Voter\DoAdminImportVoter' shared service.
...
return $this->privates['debug.security.voter.Main\UserBundle\Security\Voter\DoAdminImportVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(($this->privates['Main\UserBundle\Security\Voter\DoAdminImportVoter'] ?? $this->load('getDoAdminImportVoterService.php')), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
