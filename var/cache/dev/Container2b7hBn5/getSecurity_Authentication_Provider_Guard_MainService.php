...
return $this->privates['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
    yield 0 => ($this->privates['Main\UserBundle\Security\LoginFormAuthentificator'] ?? $this->load('getLoginFormAuthentificatorService.php'));
}, 1), ($this->privates['security.user.provider.concrete.our_users'] ?? $this->load('getSecurity_User_Provider_Concrete_OurUsersService.php')), 'main', ($this->privates['security.user_checker'] ?? ($this->privates['security.user_checker'] = new \Symfony\Component\Security\Core\User\UserChecker())));
