...
// Returns the private 'debug.security.voter.Main\UserBundle\Security\Voter\DoNewContractVoter' shared service.
...
return $this->privates['debug.security.voter.Main\UserBundle\Security\Voter\DoNewContractVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(($this->privates['Main\UserBundle\Security\Voter\DoNewContractVoter'] ?? $this->load('getDoNewContractVoterService.php')), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()));
