...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => ($this->privates['form.extension'] ?? $this->load('getForm_ExtensionService.php'))], ($this->privates['form.resolved_type_factory'] ?? ($this->privates['form.resolved_type_factory'] = new \Symfony\Component\Form\ResolvedFormTypeFactory())));
