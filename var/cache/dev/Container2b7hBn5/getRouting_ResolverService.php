...
$instance->addLoader(($this->privates['sensio_framework_extra.routing.loader.annot_class'] ?? $this->load('getSensioFrameworkExtra_Routing_Loader_AnnotClassService.php')));
$instance->addLoader(($this->privates['sensio_framework_extra.routing.loader.annot_dir'] ?? $this->load('getSensioFrameworkExtra_Routing_Loader_AnnotDirService.php')));
$instance->addLoader(($this->privates['sensio_framework_extra.routing.loader.annot_file'] ?? $this->load('getSensioFrameworkExtra_Routing_Loader_AnnotFileService.php')));
