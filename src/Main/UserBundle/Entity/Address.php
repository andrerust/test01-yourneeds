...
/**
 * @ORM\Entity(repositoryClass="Main\UserBundle\Repository\AddressRepository")
...
class Address
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Main\InsuranceBundle\Entity\Company", inversedBy="addresses")
     */
    private $company;
    
    /**
     * @ORM\ManyToOne(targetEntity="Main\UserBundle\Entity\BenefitPartner", inversedBy="addresses")
     */
