...
class SurveyToTariffNewParser extends TariffSurveyParser
{
    ...
    {
        $this->logPush("=> SurveyToTariffNewParser:parseSubmittedValues entered ", " ");
    ...
    public function buildReferenceListStructureEntry($sourceList)
    {
        ...
        foreach ($sourceList AS $attribute) {
            ...
            if (isset($attribute['Attribut']) && isset($attribute['Wert']))
