...
use DateTime;
use Main\InsuranceBundle\Helper\Url\PliUrlBuilder;

class PliApplicationUrlBuilder extends PliUrlBuilder
{
    ...
    private function generateAddress()
    {
        ...
        $this->updateUrl($keyStreetNumber, $valueStreetNumber);
...
*/
    ...
    {
        return $this->baseUrl . '?id=' . $this->brokerId . $this->brokerSubId . '&IP_USER=' . $this->userIp;
    }
    ...
    protected function init()
    {
        ...
        $this->updateUrl('sp_lang', 'haftpflicht');
    }
