...
/**
 * @ORM\Entity(repositoryClass="Main\InsuranceBundle\Repository\TypeRepository")
...
class Type
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Main\InsuranceBundle\Entity\Damage", mappedBy="type", fetch="EXTRA_LAZY", cascade={"persist"})
     */
    private $damages;
     ...
     * @return mixed
     */
    public function getProcessTariffTracker()
    {
        return $this->processTariffTracker;
    }

    /**
     * @param mixed $processTariffTracker
     */
    public function setProcessTariffTracker($processTariffTracker)
    {
        $this->processTariffTracker = $processTariffTracker;
    }
